                  ...
                  <div class="row align-items-center" style="height: 100%;">
                      <div class="col">
                          <div class="card" style="width: 18rem;">
                              <img src="_imagens/EngenhoR.png" class="card-img-top" alt="...">
                              <div class="card-body">
                                <h5 class="card-title">Engenho de Dentro</h5>
                                <p class="card-text">Localizada na Rua Goiás</p>
              ...
              <div class="col">
                <div class="container" style="height: 100%;">
                  <div class="row align-items-center" style="height: 100%;">
                      <div class="col">
                          <div class="card" style="width: 18rem;">
                              <img src="_imagens/BarraTijucaR.png" class="card-img-top" alt="...">
                              <div class="card-body">
                                <h5 class="card-title">Barra da Tijuca</h5>
                                <p class="card-text">Localizada na rua ibarapoera</p>
                                <a href="#" class="btn btn-primary">Venha conferir</a>
                              </div>
                            </div>
                      </div>
                  </div>
              ...
              <div class="col">
                <div class="container" style="height: 100%;">
                  <div class="row align-items-center" style="height: 100%;">
                      <div class="col">
                          <div class="card" style="width: 18rem;">
                              <img src="_imagens/SaoBentoR.png" class="card-img-top" alt="...">
                              <div class="card-body">
                                <h5 class="card-title">São bento</h5>
                                <p class="card-text">Localizada na Rua da freguesia</p>
                                <a href="#" class="btn btn-primary">Venha conferir</a>
                              </div>
                            </div>
                      </div>
